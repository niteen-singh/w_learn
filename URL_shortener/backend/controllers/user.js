...
function handlerUserSignUpPage (req, res) {
...
function handlerUserLoginPage (req, res) {
...
async function handlerAnalytics(req, res) {
    try{
        ...
        return res.render("analytics", {users: result.rows});
        //res.status(200).json({
...
module.exports = {
    handlerUserSignUpPage,
    handlerUserSignUp,
    handlerUserLoginPage,
    handlerUserLogin,
    handlerMainPage,
    handlerAnalytics,
    handlerRedirect
